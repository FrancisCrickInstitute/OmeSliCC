...
latex_documents = [
    (master_doc, 'OmeSliCC.tex', 'OmeSliCC Documentation',
     'Francis Crick Institute', 'manual'),
]
...
man_pages = [
    (master_doc, 'OmeSliCC', 'OmeSliCC Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'OmeSliCC', 'OmeSliCC Documentation',
     author, 'OmeSliCC', 'Ome(ro) Slide Image Conversion and Compression pipeline',
     'Miscellaneous'),
]
